...
import {CommentDbModel} from "../features/comments/commentModel";
...
export const commentCollection: Collection<CommentDbModel> = db.collection<CommentDbModel>(appConfig.COMMENTS_COLLECTION_NAME)
